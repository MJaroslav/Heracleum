...
public class IconScaledWavefrontObject implements IModelCustom {
    ...
    public IconScaledWavefrontObject(ResourceLocation resource) throws ModelFormatException {
    ...
    public IconScaledWavefrontObject(String filename, InputStream inputStream) throws ModelFormatException {
        this.fileName = filename;
        loadObjModel(inputStream);
    }

    protected void loadObjModel(InputStream inputStream) throws ModelFormatException {
            ...
            while ((currentLine = reader.readLine()) != null) {
                ...
                if (currentLine.startsWith("v ")) {
                    ...
                    if (currentGroupObject == null) {
                        currentGroupObject = new IconScaledGroupObject("Default");
                    }

                    IconScaledFace face = parseFace(currentLine, lineCount);

                    currentGroupObject.faces.add(face);
                } else if (currentLine.startsWith("g ") | currentLine.startsWith("o ")) {
                    IconScaledGroupObject group = parseGroupObject(currentLine, lineCount);
    ...
    public void tessellateAll(Tessellator tessellator) {
        for (IconScaledGroupObject groupObject : groupObjects) {
            groupObject.render(tessellator);
        }
    }

    @SideOnly(Side.CLIENT)
    public void tessellateAll(IIcon icon, Tessellator tessellator) {
        for (IconScaledGroupObject groupObject : groupObjects) {
            groupObject.render(icon, tessellator);
        }
    }
    ...
    @SideOnly(Side.CLIENT)
    public void tessellateOnly(IIcon icon, Tessellator tessellator, String... groupNames) {
        for (IconScaledGroupObject groupObject : groupObjects) {
            for (String groupName : groupNames) {
                if (groupName.equalsIgnoreCase(groupObject.name)) {
                    groupObject.render(icon, tessellator);
    ...
    @SideOnly(Side.CLIENT)
    public void tessellatePart(IIcon icon, Tessellator tessellator, String partName) {
        for (IconScaledGroupObject groupObject : groupObjects) {
            if (partName.equalsIgnoreCase(groupObject.name)) {
                groupObject.render(icon, tessellator);
            }
    ...
    @SideOnly(Side.CLIENT)
    public void tessellateAllExcept(IIcon icon, Tessellator tessellator, String... excludedGroupNames) {
        boolean exclude;
        for (IconScaledGroupObject groupObject : groupObjects) {
            exclude = false;
            for (String excludedGroupName : excludedGroupNames) {
    ...
    protected Vertex parseVertex(String line, int lineCount) throws ModelFormatException {
        Vertex vertex = null;
    ...
    protected Vertex parseVertexNormal(String line, int lineCount) throws ModelFormatException {
    ...
    protected TextureCoordinate parseTextureCoordinate(String line, int lineCount) throws ModelFormatException {
    ...
    protected IconScaledFace parseFace(String line, int lineCount) throws ModelFormatException {
        IconScaledFace face;
    ...
    protected IconScaledGroupObject parseGroupObject(String line, int lineCount) throws ModelFormatException {
        ...
        if (isValidGroupObjectLine(line)) {
            ...
            if (trimmedLine.length() > 0) {
                group = new IconScaledGroupObject(trimmedLine);
            }
        } else {
            throw new ModelFormatException("Error parsing entry ('" + line + "'" + ", line " + lineCount + ") in file '" + fileName + "' - Incorrect format");
        }
     ...
     */
    protected static boolean isValidVertexLine(String line) {
     ...
     */
    protected static boolean isValidVertexNormalLine(String line) {
     ...
     */
    protected static boolean isValidTextureCoordinateLine(String line) {
     ...
     */
    protected static boolean isValidFace_V_VT_VN_Line(String line) {
     ...
     */
    protected static boolean isValidFace_V_VT_Line(String line) {
     ...
     */
    protected static boolean isValidFace_V_VN_Line(String line) {
     ...
     */
    protected static boolean isValidFace_V_Line(String line) {
     ...
     */
    protected static boolean isValidFaceLine(String line) {
     ...
     */
    protected static boolean isValidGroupObjectLine(String line) {
